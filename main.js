...
// - インスタンスは変数 `me` に代入する
const me = new Person("りょっけ", 27, "male", 218, 60);

// 課題3: 課題2で生成したインスタンスの情報をconsole.logを使って、「名前」「年齢」「性別」「身長」「体重」が正しくセットされていることを確認する
console.log('me.nameはりょっけであるべき：', me.name);
console.log('me.ageは27であるべき：', me.age);
console.log('me.genderはmaleであるべき：', me.gender);
console.log('me.heightは218であるべき：', me.height);
console.log('me.weightは60であるべき：', me.weight);
